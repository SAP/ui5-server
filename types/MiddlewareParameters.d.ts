import type { MiddlewareUtil } from "./MiddlewareUtil.d.ts";
import type { TaskUtil } from "@ui5/project/build/helpers/TaskUtil";

// Mock some of the types, so it would be easier to follow
declare type ui5_logger_Logger = object
declare type ui5_fs_AbstractReader = object
...
declare interface MiddlewareParametersBase {
...
declare interface MiddlewareParameters_2_0<specVersion extends availableSpecVersions> extends MiddlewareParametersBase {
	middlewareUtil: MiddlewareUtil<specVersion>;
}

declare interface MiddlewareParameters_2_2<specVersion extends availableSpecVersions> extends MiddlewareParameters_2_0<specVersion> {
	taskUtil: TaskUtil<specVersion>
}

export declare type MiddlewareParameters<specVersion extends availableSpecVersions> = specVersion extends "2.0"
