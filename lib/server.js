 ...
 * @param {string} [options.h2=false] Whether HTTP/2 should be used - defaults to <code>http</code>
 ...
 * @returns {Promise<Object>} Promise resolving with an object containing the <code>port</code> once the server is listening
 */
