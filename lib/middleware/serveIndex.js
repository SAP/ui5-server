 ...
 * @param {boolean} [parameters.showDetails=true] Show detailed view.
 * @param {boolean} [parameters.showHidden=false] Show hidden files.
 * @returns {Function} Returns a server middleware closure.
 */

function createMiddleware({resources, showDetails = true, showHidden = false}) {
